...
urlpatterns = [
    ...
    # Userprofile URLs
    path('userprofiles/', user_views.UserProfileListCreateView.as_view(), name='userprofile-list'),
    path('userprofiles/<int:pk>/', user_views.UserProfileRetrieveUpdateDestroyView.as_view(), name='userprofile-detail'),
